...
void ordena(int left, int right, long long int* arr, long long int* comparacoes, long long int* movimentacoes, long long int mov, long long int comp, int cenario)
{
    ...
    comp++;
    if (left < j) ordena(left, j, arr, comparacoes, movimentacoes,mov, comp,cenario);
    comp++;
    if (i < right) ordena(i, right, arr, comparacoes, movimentacoes,mov,comp,cenario);
...
void ordena2(int left, int right, vetor* vet, long long int* comparacoes, long long int* movimentacoes, long long int mov, long long int comp, int cenario)
{
    ...
    comp++;
    if (left < j) ordena2(left, j, vet, comparacoes, movimentacoes,mov, comp,cenario);
    comp++;
    if (i < right) ordena2(i, right, vet, comparacoes, movimentacoes,mov,comp,cenario);
